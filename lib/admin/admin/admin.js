...
import AdminVotes from '../admin-votes/component'
...
import {
  ...
  findTag,
  clearTagStore
} from '../../middlewares/tag-middlewares/tag-middlewares'
...
page(urlBuilder.for('admin.topics.id.votes'), privileges('canCreateTopics'), findTopic, (ctx) => {
  ctx.sidebar.set('topics')
  render(<AdminVotes forum={ctx.forum} topic={ctx.topic} />, document.querySelector('.admin-content'))
})