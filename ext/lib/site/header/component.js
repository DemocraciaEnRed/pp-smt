        ...
        <nav className='navbar navbar-fixed-top navbar-vilo' style={styles} >
          ...
          <ul
            ...
            <MobileMenu
              ...
              userStatefulfilled={userState.fulfilled}
              UserMenuOn={this.state.userMenu}
              UserToggleOnClick={this.toggleUserMenu}
            />
      ...
      return (
        <nav className='navbar navbar-fixed-top navbar-vilo' style={styles}>
          ...
          <ul className='nav navbar-nav'>
            ...
            {forumConfig && getYears(forumConfig, 'seguimiento').length > 0 && <li className={`header-item ${window.location.pathname.includes('/catalogo') ? 'active' : ''}`}>
              <Link
                to='/catalogo'
                className='header-link'
                tabIndex="83"
            ...
            {forumConfig && forumConfig.stage === 'votacion' && <li className={`header-item ${window.location.pathname.includes('/votacion') ? 'active' : ''}`}>
              <Link
                to='/votacion'
                className='header-link'
                tabIndex="84"
