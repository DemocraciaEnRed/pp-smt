          ...
          <div className='footer-info'>
            <div className='contacto-detalles'>
              ...
              <div className='social-icon'>
                ...
                <a aria-label='Ícono de twitter' className='social-twitter' tabIndex="104" href='https://x.com/CiudadSMT' target="_blank" />
                {/* <a aria-label='Ícono de mail' className='social-mail' tabIndex="105" href='mailto:speak@democraciaenred.org' target="_blank" /> */}
              </div>
            </div>

            <div className='logos'>
              <a href="https://smt.gob.ar/" rel="noopener noreferer" target="_blank">
                <div className='logo-smt'>
                  <img src="/ext/lib/boot/logo-smt.png" alt="Logo democracia en red" />
                </div>
              </a>
              <a href="https://democraciaos.org/es/" rel="noopener noreferer" target="_blank">
